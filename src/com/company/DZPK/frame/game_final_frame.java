...
public class  game_final_frame {
	...
	private void initialize() {
		...
		player_rank_label[0].setFont(new Font("����", Font.PLAIN, 32));
		...
		player_rank_label[1].setFont(new Font("����", Font.PLAIN, 32));
		...
		player_rank_label[2].setFont(new Font("����", Font.PLAIN, 32));
		...
		player_rank_label[3].setFont(new Font("����", Font.PLAIN, 32));
		...
		player_rank_label[4].setFont(new Font("����", Font.PLAIN, 32));
		...
		player_rank_label[5].setFont(new Font("����", Font.PLAIN, 32));
		...
		return_button.setFont(new Font("����", Font.PLAIN, 32));
