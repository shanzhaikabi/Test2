...
public class login_frame {
	...
	private JTextArea warning_textpane;
	...
	private void initialize() {
		...
		currentpeople_label.setFont(new Font("宋体", Font.PLAIN, 32));
		...
		currentplayer_label.setFont(new Font("宋体", Font.PLAIN, 32));
		...
		currentgame_label.setFont(new Font("宋体", Font.PLAIN, 32));
		...
		other_label.setFont(new Font("宋体", Font.PLAIN, 18));
		...
		gamename_label.setFont(new Font("宋体", Font.PLAIN, 18));
		...
		account_field.setFont(new Font("宋体", Font.PLAIN, 18));
		...
		password_field.setFont(new Font("宋体", Font.PLAIN, 18));
		...
		register_button.setFont(new Font("宋体", Font.PLAIN, 18));
		register_button.setBounds(360, 323, 80, 32);
		login_frame.getContentPane().add(register_button);
		
		warning_textpane = new JTextArea();
		warning_textpane.setBackground(SystemColor.control);
		warning_textpane.setFont(new Font("宋体", Font.PLAIN, 32));
		warning_textpane.setText("       \u5065\u5EB7\u6E38\u620F\u5FE0\u544A\r\n\u62B5\u5236\u4E0D\u826F\u6E38\u620F, \u62D2\u7EDD\u76D7\u7248\u6E38\u620F\u3002\r\n\u6CE8\u610F\u81EA\u6211\u4FDD\u62A4, \u8C28\u9632\u53D7\u9A97\u4E0A\u5F53\u3002\r\n\u9002\u5EA6\u6E38\u620F\u76CA\u8111, \u6C89\u8FF7\u6E38\u620F\u4F24\u8EAB\u3002\r\n\u5408\u7406\u5B89\u6392\u65F6\u95F4, \u4EAB\u53D7\u5065\u5EB7\u751F\u6D3B\u3002");
		warning_textpane.setBounds(537, 397, 462, 220);
		login_frame.getContentPane().add(warning_textpane);
	}
}
